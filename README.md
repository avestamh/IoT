the code include reading, cleaning, normalizing, and visualizing data from measuring TVBN data of steak. the image is represnting one of the output of the code
